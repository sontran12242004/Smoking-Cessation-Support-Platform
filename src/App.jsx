...
import SendReminder from "./Admin/AdminContents/SendReminder";
  ...
  return (
    <UserProvider>
      <Routes>
        ...
        <Route
          path="/elite/book-appointment"
          element={<EliteBookAppointment />}
        />
        <Route path="/elite/community" element={<EliteCommunity />} />
        <Route path="/elite/feedback" element={<EliteFeedback />} />
        <Route
          path="/elite/notification"
          element={<EliteNotificationsCenter />}
        />
        ...
        <Route
          ...
          element={<StandardMemberDashboard />}
        />
        ...
        <Route
          ...
          element={<StandardEditProfile />}
        />
        <Route
          path="/standard/questionnaire"
          element={<StandardQuestionnaire />}
        />
        <Route
          path="/standard/timeofsuccess"
          element={<StandardTimeofSuccess />}
        />
        <Route
          path="/standard-subscription"
          element={<StandardViewSubscription />}
        />
