...
function StandardMemberDashboard() {
  ...
  if (!userId) {
    try {
      ...
      console.error('StandardMemberDashboard - error parsing localStorage user:', error);
    }
  }
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch health metrics data similar to Elite Dashboard
        const [
          lungCancerRiskData,
        ...
        setHealthMetrics({
          daysSmokeFree: formatNumber(actualDaysSmokeFree),
          daysToNext: "--", // This would need a specific API call
          moneySaved: formatNumber(actualMoneySaved, 2),
          healthImproved: formatNumber(actualHealthImproved),
          lungsCapacity: "--", // These might be locked for standard members
          heartRate: "--",
        });
  ...
  const showLockedFeatureAlert = () => {
    alert('This feature is locked for Standard members. Please upgrade to Elite to unlock.');
  };
  ...
  return (
    <div className="dashboard-bg" style={{ background: `url(${journeyPath}) center/cover no-repeat`, position: 'relative' }}>
      ...
      <nav className="welcome-nav">
        <ul>
          <li>
            <Link to="/standard/home">Home</Link>
          </li>
          <li>
            <Link to="/standard/dashboard" className="active">Dashboard</Link>
          </li>
          <li>
      ...
      <div className="dashboard-main">
        ...
        <div className="dashboard-cards-row">
          <div className="dashboard-card">
            ...
            <div className="dashboard-card-value">{healthMetrics.daysSmokeFree}</div>
          ...
          <div className="dashboard-card">
            <span className="dashboard-card-icon">💵</span>
            <div className="dashboard-card-value">${healthMetrics.moneySaved}</div>
          ...
          <div className="dashboard-card">
            <span className="dashboard-card-icon">💚</span>
            <div className="dashboard-card-value">{healthMetrics.healthImproved}%</div>
        ...
        <div className="analytics-cards-row">
          <div className="analytics-card">
            ...
            <div className="analytics-card-content">
              ...
              <div className="analytics-locked-message">This feature is locked</div>
              <div className="analytics-upgrade-text">Upgrade to Elite to unlock detailed analytics</div>
              <button className="analytics-upgrade-btn" onClick={handleUpgrade}>
                Upgrade to Elite
              </button>
            </div>
          </div>
