    ...
    <div className="container">
      ...
      <nav className="welcome-nav">
        <ul>
          ...
          <li><Link to="/standard/achievement" className="active">Achievement</Link></li>
      ...
      <main>
        ...
        <div className="main-content">
          <div className="locked-feature-card">
            ...
            <div className="upgrade-text">Upgrade to Elite to view your achievements and milestones.</div>
...
export default StandardAchievement;
