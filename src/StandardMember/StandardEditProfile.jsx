...
function StandardEditProfile() {
  ...
  useEffect(() => {
    ...
    console.log('StandardEditProfile - Debug info:', {
      user,
      memberId,
      ...
      <div className="content-wrap">
        <header className="welcome-header">
          <div className="header-left">
            <button className="profile-btn">Standard Member</button>
          </div>
...
export default StandardEditProfile;
