  ...
  return (
    <div className="elite-home-container">
      ...
      <nav className="elite-nav">
        <ul>
          <li>
            <Link to="/elite/home" className="active">
              Home
            </Link>
          </li>
          <li>
      ...
      <main className="main-content-elite">
        ...
        >
          <div className="checkin-left-column">
            ...
            <button
              ...
              onClick={() => navigate("/elite/daily-checkin")}
            >
              Go To My Diary
            </button>
          </div>
        ...
        <button
          ...
          ref={planButtonRef}
          onClick={() => navigate("/elite/questionnaire")}
        >
          Create My Quit Plan →
        </button>
        ...
        >
          <Link to="/elite/dashboard" className="view-dashboard-link">
            View Your Dashboard →
          </Link>
        </section>
      </main>
