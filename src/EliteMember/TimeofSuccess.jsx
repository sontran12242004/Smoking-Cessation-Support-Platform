  ...
  return (
    <div className="welcome-page-container">
      ...
      <nav className="welcome-nav">
        <ul>
          <li>
            <NavLink to="/elite/home" className="nav-link">
              Home
            </NavLink>
          </li>
          <li>
            <NavLink to="/elite/dashboard" className="nav-link">
              Dashboard
            </NavLink>
          </li>
          <li>
            <NavLink to="/elite/achievement" className="nav-link">
              Achievement
            </NavLink>
          </li>
          <li>
            <NavLink to="/elite/coach" className="nav-link">
              Coach
            </NavLink>
          </li>
          <li>
            <NavLink to="/elite/community" className="nav-link">
              Community
            </NavLink>
          </li>
          <li>
            <NavLink to="/elite/feedback" className="nav-link">
              Feedback
            </NavLink>
          </li>
        </ul>
      ...
      <main className="time-of-success-main-content">
        <div className="top-section-text">ESTIMATED TIME OF SUCCESS</div>
        ...
        <div className="progress-card">
          ...
          <div className="time-smoke-free">
            <span className="number">{progress.daysSinceQuit}</span>
            <span className="label">Days</span>
            <span className="number">{progress.hoursSinceQuit}</span>
            <span className="label">Hours</span>
            <span className="number">{progress.minutesSinceQuit}</span>
          ...
          <ul className="milestone-list">
            <li
              className={`milestone-item ${
                progress.daysSinceQuit >= 2 ? "completed" : "upcoming"
              }`}
            >
            ...
            <li
              className={`milestone-item ${
                progress.daysSinceQuit >= 14 ? "completed" : "upcoming"
              }`}
            >
            ...
            <li
              className={`milestone-item ${
                progress.daysSinceQuit >= 90 ? "completed" : "upcoming"
              }`}
            >
            ...
            <li
              className={`milestone-item ${
                progress.daysSinceQuit >= 365 ? "completed" : "upcoming"
              }`}
            >
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="newsletter-signup">
              ...
              <p>
                Get the latest tips and motivation to stay smoke-free delivered
                to your inbox
              </p>
            </div>
          </div>
