...
import AddEmailMotivationModal from './AddEmailMotivationModal';
import EditEmailMotivationModal from './EditEmailMotivationModal';

const SevenDaysMotivationalMessages = () => {
...
export default SevenDaysMotivationalMessages; 