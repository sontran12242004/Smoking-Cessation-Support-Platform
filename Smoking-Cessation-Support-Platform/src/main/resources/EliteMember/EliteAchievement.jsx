        ...
        <div className="ea-container">
          ...
          <div className="ea-badge-card">
            <div className="ea-badge-grid">
              {/* Row 1: Days */}
              <div className="ea-badge-item"><span className="ea-badge-icon" role="img" aria-label="3 Days">🏆</span><div className="ea-badge-label">First 3 Days</div></div>
              <div className="ea-badge-item"><span className="ea-badge-icon" role="img" aria-label="7 Days">🏆</span><div className="ea-badge-label">First 7 Days</div></div>
              <div></div>
              <div></div>
              {/* Row 2: Months */}
              <div className="ea-badge-item"><span className="ea-badge-icon" role="img" aria-label="1 Month">🏆</span><div className="ea-badge-label">First Month</div></div>
              <div className="ea-badge-item stars"><span className="ea-badge-icon" role="img" aria-label="3 Months">🏆</span><div className="ea-badge-label">3 Months</div></div>
              <div className="ea-badge-item special"><span className="ea-badge-icon" role="img" aria-label="9 Months">🏆</span><div className="ea-badge-label">9 Months</div></div>
              <div></div>
              {/* Row 3: Money badges */}
              <div className="ea-badge-item money"><span className="ea-badge-icon" role="img" aria-label="$30 Saved">🏆</span><div className="ea-badge-label">$30 Saved</div></div>
              <div className="ea-badge-item money"><span className="ea-badge-icon" role="img" aria-label="$50 Saved">🏆</span><div className="ea-badge-label">$50 Saved</div></div>
              <div className="ea-badge-item money"><span className="ea-badge-icon" role="img" aria-label="$100 Saved">🏆</span><div className="ea-badge-label">$100 Saved</div></div>
              <div className="ea-badge-item money"><span className="ea-badge-icon" role="img" aria-label="$150 Saved">🏆</span><div className="ea-badge-label">$150 Saved</div></div>
              {/* Row 4: $300 Saved */}
              <div className="ea-badge-item money"><span className="ea-badge-icon" role="img" aria-label="$300 Saved">🏆</span><div className="ea-badge-label">$300 Saved</div></div>
              <div></div>
              <div></div>
              <div></div>
            </div>
          ...
          <div className="ea-progress-card">
            <div className="ea-streak-main">
              ...
              <div className="ea-streak-value">268 days smoke-free</div>
            </div>
          </div>
          ...
          <div className="ea-challenge-card">
            <div className="ea-challenge-title"><b>Current Challenge: 1-Year Smoke-Free</b></div>
            <div className="ea-challenge-desc"><b>268/365 Days Complete (73%)</b></div>
            <div className="ea-challenge-bar-bg">
              <div className="ea-challenge-bar-fill"></div>
            </div>
          </div>
          ...
          <div className="ea-achievement-gallery-box">
            ...
            <div className="ea-achievement-gallery-desc">Celebrate every step of your smoke-free jouney</div>
          </div>
          ...
          <div className="ea-milestone-grid">
            ...
            <div className="ea-milestone-card done">
              <div className="ea-milestone-number">3</div>
              <div className="ea-milestone-title"><b>3-Day Streak</b></div>
              <div className="ea-milestone-desc">First milestone</div>
              <div className="ea-milestone-underline"></div>
            </div>
            <div className="ea-milestone-card done">
              <div className="ea-milestone-number">7</div>
              <div className="ea-milestone-title"><b>7-Day Streak</b></div>
              <div className="ea-milestone-desc">Cacbon Monoxide<br/>levels normalized</div>
              <div className="ea-milestone-underline"></div>
            </div>
            <div className="ea-milestone-card done">
              <div className="ea-milestone-number">14</div>
              <div className="ea-milestone-title"><b>14-Day Streak</b></div>
              <div className="ea-milestone-desc">Circulation improved</div>
              <div className="ea-milestone-underline"></div>
            </div>
            <div className="ea-milestone-card done">
              <div className="ea-milestone-number">30</div>
              <div className="ea-milestone-title"><b>30-Day Streak</b></div>
              <div className="ea-milestone-desc">Lung function increses</div>
              <div className="ea-milestone-underline"></div>
            </div>
            <div className="ea-milestone-card done">
              <div className="ea-milestone-number">90</div>
              <div className="ea-milestone-title"><b>3-Months Streak</b></div>
              <div className="ea-milestone-desc">The immune system<br/>works better.</div>
              <div className="ea-milestone-underline"></div>
            </div>
            <div className="ea-milestone-card done">
              <div className="ea-milestone-number">180</div>
              <div className="ea-milestone-title"><b>6-Months Streak</b></div>
              <div className="ea-milestone-desc">Less infections, brighter<br/>skin</div>
              <div className="ea-milestone-underline"></div>
            </div>
            {/* Incomplete milestones */}
            <div className="ea-milestone-card disabled">
              <div className="ea-milestone-number disabled">270</div>
              <div className="ea-milestone-title disabled"><b>2 Days to go</b></div>
              <div className="ea-milestone-title disabled">9-Months Streak</div>
              <div className="ea-milestone-desc disabled">Cleaner lungs, easier<br/>breathing</div>
            </div>
            <div className="ea-milestone-card disabled">
              <div className="ea-milestone-number disabled">365</div>
              <div className="ea-milestone-title disabled"><b>93 Days to go</b></div>
              <div className="ea-milestone-title disabled">12-Months Streak</div>
              <div className="ea-milestone-desc disabled">Heart risk halved</div>
            </div>
          </div>
