    ...
    <div className="container">
      <div className="login-wrapper">
        <div className="left-panel">
          ...
          <div className="welcome">Welcome back to your<br />smoke-free journey</div>
          <div className="desc">
        ...
        <div className="right-panel">
          <h2>Login</h2>
          <div className="subtitle">Access your personalized dashboard</div>
      ...
      <style>{`
        ...
        .google-btn {
          ...
          cursor: pointer;
          font-size: 1rem;
          box-shadow: 0 2px 8px #4d8b3c11;
          transition: background 0.2s, box-shadow 0.2s, transform 0.18s;
          gap: 8px;
        }
        .google-btn:hover {
          background: #e8fbe8;
          box-shadow: 0 6px 24px #4d8b3c22;
