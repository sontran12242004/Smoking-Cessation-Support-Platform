  ...
  return (
    <div className="landing-root">
      ...
      <section className="harms-section">
        ...
        <div className="harms-desc">Understanding the harms of smoking is the first step toward the determination to quit.</div>
        <div className="harms-cards">
          <div className="harms-card">
            <div className="harms-icon" style={{background:'#ffe3e3'}}><span role="img" aria-label="lung">🫁</span></div>
            <div className="harms-card-title">Chronic Obstructive Pulmonary Disease (COPD)</div>
            <div className="harms-card-desc">Smoking is the main cause of COPD, a group of progressive lung diseases that impair breathing and cannot be fully reversed.</div>
            <div className="harms-card-stat" style={{background:'#eaf7ea', color:'#3a7d3a'}}>
              <b>90%</b><br/>
              <span style={{fontWeight:400}}>of COPD-related deaths are linked to smoking.</span>
            </div>
          </div>
          <div className="harms-card">
            <div className="harms-icon" style={{background:'#fff3e3'}}><span role="img" aria-label="cancer">🦠</span></div>
            <div className="harms-card-title">Cancer</div>
            <div className="harms-card-desc">Smoking increases the risk of many types of cancer—not only lung cancer, but also cancers of the mouth, throat, esophagus, stomach, pancreas, and bladder.</div>
            <div className="harms-card-stat" style={{background:'#f3f7ea', color:'#7d7d3a'}}>
              <b>30%</b><br/>
              <span style={{fontWeight:400}}>of cancer-related deaths are linked to smoking.</span>
            </div>
          </div>
          <div className="harms-card">
            <div className="harms-icon" style={{background:'#ffeaea'}}><span role="img" aria-label="heart">❤️</span></div>
            <div className="harms-card-title">Cardiovascular Disease</div>
            <div className="harms-card-desc">Smoking increases the risk of heart diseases, including heart attacks, strokes, peripheral artery disease, and aortic aneurysms.</div>
            <div className="harms-card-stat" style={{background:'#eaf7f3', color:'#3a7d7d'}}>
              <b>25%</b><br/>
              <span style={{fontWeight:400}}>of cardiovascular deaths are linked to smoking.</span>
            </div>
          </div>
          <div className="harms-card">
            <div className="harms-icon" style={{background:'#ffe3f3'}}><span role="img" aria-label="baby">👶</span></div>
            <div className="harms-card-title">Harm to the Fetus</div>
            <div className="harms-card-desc">Pregnant women who smoke have a higher risk of premature birth, low birth weight, and other pregnancy complications. Infants also face a higher risk of Sudden Infant Death Syndrome (SIDS).</div>
            <div className="harms-card-stat" style={{background:'#f3f7f3', color:'#7d3a7d'}}>
              <b>10%</b><br/>
              <span style={{fontWeight:400}}>of infant deaths are linked to smoking.</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="quit-journey-section">
        <h2 className="quit-journey-title">Your quit journey: Get support at every stage</h2>
        <div className="quit-journey-desc">
          Whether you're thinking about quitting, ready to quit, or need help staying smoke free, we've got tips and support to help you at every stage. Learn how to get through the tough times, stay focused, and quit for good.<br/><br/>
          You deserve a healthier, smoke-free life. Let's get started!
        </div>
        <div className="quit-journey-cards">
          <div className="quit-journey-card">
            <div className="quit-journey-icon" style={{color:'#ffb800'}}><span role="img" aria-label="lightbulb">💡</span></div>
            <div className="quit-journey-card-title">Why quit smoking</div>
            <div className="quit-journey-card-desc">Learn how quitting smoking can make life better for you and those around you. Explore the benefits, understand the hidden costs, and get the truth about smoking, stress, and mental health.</div>
          </div>
          <div className="quit-journey-card">
            <div className="quit-journey-icon" style={{color:'#ffb800'}}><span role="img" aria-label="bin">🗑️</span></div>
            <div className="quit-journey-card-title">Ready to quit smoking</div>
            <div className="quit-journey-card-desc">Get the support you need to quit for good! There are more proven ways to stop smoking than ever before. Find out what can help with cravings and explore expert and community support to keep you on track.</div>
          </div>
          <div className="quit-journey-card">
            <div className="quit-journey-icon" style={{color:'#ffd600'}}><span role="img" aria-label="heart">💛</span></div>
            <div className="quit-journey-card-title">Staying smoke free</div>
            <div className="quit-journey-card-desc">Learn how to handle cravings, manage withdrawal symptoms, and get back on track if you slip up. Find tips to help you stay focused and enjoy a healthier, smoke-free life</div>
          </div>
        </div>
      </section>
      ...
      <section className="timeline-section">
        ...
        <div className="timeline-desc">Smoking doesn't just cause immediate harm—it also leaves serious long-term consequences.</div>
        <div className="timeline-container">
          ...
          <div className="timeline-item timeline-item-left">
            ...
            <div className="timeline-box">
              ...
              <ul>
                <li>2 to 4 times higher risk of developing cardiovascular diseases</li>
      ...
      <section className="benefits-section">
        ...
        <div className="benefits-desc">Your body begins to recover as soon as you stop smoking your last cigarette.</div>
        <div className="benefits-cards">
          <div className="benefits-card">
            <div className="benefits-icon">⏱️</div>
            <div className="benefits-badge">20 minutes</div>
            <div className="benefits-card-title">Blood pressure and heart rate decrease</div>
            <div className="benefits-card-desc">Just 20 minutes after your last cigarette, your blood pressure and heart rate begin to return to normal.<br/>12 hours</div>
          </div>
          <div className="benefits-card">
            ...
            <div className="benefits-card-desc">After 12 hours, the level of carbon monoxide in your blood drops to normal, allowing oxygen to be transported more efficiently.</div>
          </div>
          <div className="benefits-card">
            <div className="benefits-icon">💪</div>
            <div className="benefits-badge">2–12 weeks</div>
            <div className="benefits-card-title">Improved circulation</div>
            <div className="benefits-card-desc">Between 2 to 12 weeks, blood circulation improves and lung function increases significantly.</div>
          </div>
          <div className="benefits-card">
            <div className="benefits-icon">😮‍💨</div>
            <div className="benefits-badge">1–9 months</div>
            <div className="benefits-card-title">CO levels decrease</div>
            <div className="benefits-card-desc">Coughing, nasal congestion, and shortness of breath decrease. The lungs begin to cleanse themselves, reducing the risk of infection.</div>
          </div>
          <div className="benefits-card">
            <div className="benefits-icon">❤️</div>
            <div className="benefits-badge">1 year</div>
            <div className="benefits-card-title">Reduced risk of heart disease</div>
            <div className="benefits-card-desc">After 1 year, the risk of coronary heart disease drops to half that of a smoker.</div>
          </div>
          <div className="benefits-card">
            <div className="benefits-icon">💓</div>
            <div className="benefits-badge">5–15 years</div>
            <div className="benefits-card-title">Blood pressure and heart rate decrease</div>
            <div className="benefits-card-desc">After 5 to 15 years, the risk of stroke is similar to that of a non-smoker.</div>
          </div>
          <div className="benefits-card">
            <div className="benefits-icon">🦠</div>
            <div className="benefits-badge">10 years</div>
            <div className="benefits-card-title">Reduced risk of lung cancer</div>
            <div className="benefits-card-desc">After 10 years, the risk of dying from lung cancer is about half that of someone who continues to smoke.</div>
          </div>
          <div className="benefits-card">
            <div className="benefits-icon">🏆</div>
            <div className="benefits-badge">15 years</div>
            <div className="benefits-card-title">Heart disease risk equals that of a non-smoker</div>
            <div className="benefits-card-desc">After 15 years, the risk of coronary heart disease is the same as that of someone who has never smoked.</div>
          </div>
        </div>
      </section>
      ...
      <section className="nicoff-helps-section">
        ...
        <div className="nicoff-helps-cards">
          <div className="nicoff-helps-card">
            <div className="nicoff-helps-icon" style={{fontSize:'38px'}}>📊</div>
            <div className="nicoff-helps-card-title">Progress Tracking</div>
            <div className="nicoff-helps-card-desc">Monitor your smoke-free days, money saved, and health improvements with our intuitive dashboard and real-time analytics.</div>
          </div>
          <div className="nicoff-helps-card">
            <div className="nicoff-helps-icon" style={{fontSize:'38px'}}>🏅</div>
            <div className="nicoff-helps-card-title">Achievements</div>
            <div className="nicoff-helps-card-desc">Earn badges and rewards as you reach milestones in your quitting journey. Celebrate every smoke-free day!</div>
          </div>
          <div className="nicoff-helps-card">
            <div className="nicoff-helps-icon" style={{fontSize:'38px'}}>🤝</div>
            <div className="nicoff-helps-card-title">Community Support</div>
            <div className="nicoff-helps-card-desc">Connect with others who are quitting through our forums and group chats. Share tips, struggles, and successes.</div>
          </div>
        </div>
      </section>
      ...
      <section className="stories-section">
        <h2 className="stories-title">Real-life stories from people who have quit smoking</h2>
        <div className="stories-cards">
          <div className="stories-card">
            <div className="stories-quote stories-quote-yellow">“</div>
            <div className="stories-content">I smoked for over 25 years, and it wasn't easy breaking the habit. But what worked was choosing a quit date and getting help from my local Stop Smoking Service. I don't have cravings anymore and will never put a cigarette in my mouth again.</div>
