...
const EditEmailMotivationModal = ({ onClose, onSave, initialMessage }) => {
  ...
  useEffect(() => {
    if (initialMessage) {
      setDayNo(`Day ${initialMessage.day}`);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSave({ ...initialMessage, title, content });
    onClose();
  };
    ...
    <div style={styles.modalOverlay}>
      <div style={styles.modalContent}>
        <div style={styles.modalHeader}>
          <h2 style={styles.modalTitle}>Edit Reminder</h2>
...
export default EditEmailMotivationModal; 