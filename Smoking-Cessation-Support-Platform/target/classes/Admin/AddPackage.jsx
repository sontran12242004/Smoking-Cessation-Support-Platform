    ...
    <div style={styles.bg}>
      <div style={styles.popup}>
        ...
        <form style={styles.form}>
          ...
          <input style={styles.input} placeholder="Package Name" />

          <label style={styles.label}>Price</label>
          <input style={styles.input} placeholder="Eg: $39" />

          <label style={styles.label}>Duration</label>
          <input style={styles.input} placeholder="Eg: 2 months, 3 months ..." />
          ...
          <textarea style={{ ...styles.input, minHeight: 60 }} placeholder="Eg: This is our newest Package" />

          <div style={styles.btnRow}>
            <button type="button" style={styles.cancelBtn} onClick={() => navigate('/packages')}>Cancel</button>
            <button type="submit" style={styles.addBtn}>+ Add Package</button>
          </div>
        </form>
      </div>
    </div>
